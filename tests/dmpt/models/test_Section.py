...
class TestRepeatableSections(test.TestCase):
    ...
    def test_model_repeatable_section(self):
        plan = Plan(template=self.template, added_by_id=1, modified_by_id=1, valid=False)
        plan.save()
        ...
        as1 = AnswerSet(plan=plan, section=section, valid=False)
        as1.save()
        ...
        as2 = AnswerSet(plan=plan, section=section, valid=False)
        as2.save()
        a2_1 = Answer(answerset=as2, question=q1, plan=plan, valid=False)
        a2_2 = Answer(answerset=as2, question=q2, plan=plan, valid=False)
        a2_3 = Answer(answerset=as2, question=q3, plan=plan, valid=False)
        a2_1.save()
        a2_2.save()
        a2_3.save()

        as3 = AnswerSet(plan=plan, section=section, valid=False)
        as3.save()
        a3_1 = Answer(answerset=as3, question=q1, plan=plan, valid=False)
        a3_2 = Answer(answerset=as3, question=q2, plan=plan, valid=False)
        a3_3 = Answer(answerset=as3, question=q3, plan=plan, valid=False)
        a3_1.save()
        a3_2.save()
        a3_3.save()
