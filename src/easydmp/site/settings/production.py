...
SOCIAL_AUTH_DATAPORTEN_EMAIL_KEY = os.getenv('SOCIAL_AUTH_DATAPORTEN_EMAIL_KEY')
SOCIAL_AUTH_DATAPORTEN_EMAIL_SECRET = os.getenv('SOCIAL_AUTH_DATAPORTEN_EMAIL_SECRET')
SOCIAL_AUTH_B2ACCESS_KEY = os.getenv('SOCIAL_AUTH_B2ACCESS_KEY')
SOCIAL_AUTH_B2ACCESS_SECRET = os.getenv('SOCIAL_AUTH_B2ACCESS_SECRET')
